...
SELECT SUM(CASE WHEN transaction_id IS NULL THEN 1 ELSE 0 END) AS transaction_id_c,
       ...
       SUM(CASE WHEN "3year" IS NULL THEN 1 ELSE 0 END) AS year3_c,
       SUM(CASE WHEN "5year" IS NULL THEN 1 ELSE 0 END) AS year5_c,
       SUM(CASE WHEN "10year" IS NULL THEN 1 ELSE 0 END) AS year10_c,
...
SELECT 100.0 * SUM(CASE WHEN transaction_id IS NULL THEN 1 ELSE 0 END) / COUNT(*) AS transaction_id_p,
       ...
       100.0 * SUM(CASE WHEN "3year" IS NULL THEN 1 ELSE 0 END) / COUNT(*) AS year3_p,
       100.0 * SUM(CASE WHEN "5year" IS NULL THEN 1 ELSE 0 END) / COUNT(*) AS year5_p,
       100.0 * SUM(CASE WHEN "10year" IS NULL THEN 1 ELSE 0 END) / COUNT(*) AS year10_p,
